...
var Register = React.createClass({
    ...
    sportsList: function(){
            return(
                <select size="6" onChange={ this.selectedSports } value={this.state.Sports} multiple="multiple">                   
    ...
    getMomentDate(date) {
      ...
      genderRadio(){
          if(this.state.Gender == "Male"){
            return(
                <div>
                <input type="radio" name="gender" value="male" onChange={this.ongenderChanged} checked/><i class="fa fa-male fa-2x" aria-hidden="true"></i>
                <input type="radio" name="gender" value="female" onChange={this.ongenderChanged}/> <i class="fa fa-female fa-2x" aria-hidden="true"></i><br/>
            </div>
            )
          }
            ...
            return(
                <div>
                <input type="radio" name="gender" value="male" onChange={this.ongenderChanged} /><i class="fa fa-male fa-2x" aria-hidden="true"></i>
                <input type="radio" name="gender" value="female" onChange={this.ongenderChanged} checked/> <i class="fa fa-female fa-2x" aria-hidden="true"></i><br/>
            </div>
            )
          }
        ...
        if(this.state.tabNumber == 1){
            return(
                <div><h3>Basic Info: name, sport, nationality, gender, date of birth</h3>
                    <input type="text" class="name form-control" placeholder = "name" onChange={this.getName} value={this.state.Name}/>
                    <input type="text" class="nationality form-control" placeholder = "nationality" onChange={this.getNationality} value={this.state.Nationality}/>
                    {this.genderRadio()}
                    <div>
                            {this.sportsList()}
                    </div><br/>
                    {this.selectedList()}
                    <br/>
                    <h5>Date of Birth: </h5><DatePicker id ="datepicked" closeOnSelect={true} value={this.state.DOB} onChange={this.onChangeDate} placeholder="DateOfBirth"/>
                    <div>
                        <input type="file" accept='image/*' id="profileImage" onChange={this.getProfileImage}/>
            ...
            if(this.state.tabNumber == 2){
                return(
                    ...
                    <textarea cols="20" rows="6" type="text" class="about form-control" value= {this.state.About} placeholder = "About" onChange={this.getAbout}/>
                    <input type="text" class="interests form-control" placeholder = "Interests" onChange={this.getInterests} value={this.state.Interests}/>
                    <input type="text" class="charities form-control" placeholder = "Charities" onChange={this.getCharities} value= {this.state.Charities}/>
                        <input type="text" class="location form-control" placeholder = "location" onChange={this.getLocation} value={this.state.Location}/>
                        <input type="text" class="association form-control" placeholder = "team" onChange={this.getAssociation} value={this.state.Association}/>
                        <input type="text" class="team form-control" placeholder = "team" onChange={this.getTeam}/>
                        <div>
                ...
                if(this.state.tabNumber == 3){                    
                    return(
                        <div><h3>Social Media: handles</h3>
                            <input type="text" class="linkedin form-control" placeholder = "linkedin" value={this.state.SocialMediaHandles.linkedin} onChange={this.getLinkedin}/>
                            <input type="text" class="facebook form-control" placeholder = "facebook" value={this.state.SocialMediaHandles.facebook} onChange={this.getFacebook}/>
                            <input type="text" class="instagram form-control" placeholder = "instagram" value={this.state.SocialMediaHandles.instagram} onChange={this.getInstagram}/>
                            <div>
                                <button onClick={this.previousPage}>PREVIOUS PAGE</button>
                                <button onClick={this.nextPage} >NEXT PAGE</button>
                            </div>
